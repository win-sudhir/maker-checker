...
@WebServlet("/report/tagexception")
public class TagExceptionReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static Logger log = Logger.getLogger(TagExceptionReport.class.getName());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			finalResponse = new NETCReportsDAO().getEXCEPTIONReport(fromDate, toDate, userId, conn);
