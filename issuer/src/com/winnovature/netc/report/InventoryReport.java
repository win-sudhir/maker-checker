...
@WebServlet("/report/inventory")
public class InventoryReport extends HttpServlet {
	private static final long serialVersionUID = 1L;

	static Logger log = Logger.getLogger(InventoryReport.class.getName());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			finalResponse = new NETCReportsDAO().getINVENTORYNEWReport(fromDate, toDate, userId, conn);
			// }
		} catch (Exception e) {
			log.error(e);
			log.info(e.getMessage());
		} finally {
			log.info("*****************Response to /report/inventory API()****************");
